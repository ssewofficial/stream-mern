const en = {
  ...
  "global.micPermission":
    "In the video call scenario, please grant microphone permissions before operating the device.",
  "global.cameraPermission":
    "In the video call scenario, please grant camera permissions before operating the device.",
  "global.browserNotSupportSharing":
    "Your browser does not support screen sharing.",
  "global.shareAuthority": "Grant access to share your screen",
  "global.shareAuthorityDesc":
  ...
  "global.joinRoomFailedDesc":
    "Failed to join the room, the number of people in the room has reached the maximum.(2 people)",
  "global.joinRoomFailedNetwork":
    "There's something wrong with your network. Please check it and try again.",
  "global.joinRoomFailedToken":
    "Failed to join the room, token authentication error.",
  "global.joinRoomFailedRepeat":
    "You are on a call in another room, please leave that room first.",
  "global.joinRoomFailed":
    "Failed to join the room, please try again.（error code: {code}）",
  "global.inviteMembers": "Invite members",
  "global.invitees": "Invitees",
  "global.checkRTC":
    "This device does not support RTC, please try another device",
  ...
  "room.presentingMirrorTip":
    " To avoid an infinity mirror, we suggest you not to share your entire screen or browser window.",
  "room.ignore": "Ignore",
  "room.live": "Go Live",
  ...
  "room.appliedConnectionToast":
    "You've applied for connection, please wait for the host's confirmation.",
  ...
  "room.requestingConnectionToast":
    "{user} is requesting a connection with you.",
  ...
  "room.otherScreenPresentingToast":
    "{user}  is presenting now. You cannot share your screen.",
  "room.otherWhiteboardPresentingToast":
    "{user} is presenting now. You cannot share your whiteboard.",
  ...
  "room.enableBackgroundProcessFailed":
    "Failed to enable background blur/virtual background.",
